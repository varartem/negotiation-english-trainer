# Информационная система для тренировки переговорного английского языка

Локальное веб-приложение для тренировки переговорного английского с ИИ-собеседником. Backend использует локальные MLX-модели: LLM для сценариев, графа и диалога, STT для голосового ввода и TTS для озвучки сообщений. Также используются модели определения сантимента и эмбеддинги для определения переговорного шага.

## Скриншоты приложения

Главная страница:
![Скриншот 1](pics/1.png)
Страница создания сценария переговоров:
![Скриншот 2](pics/2.png)
Основная страница с диалогом переговоров:
![Скриншот 5](pics/5.png)
Панель с подробной аналитикой:
![Скриншот 3](pics/3.png)
Страница со словарём англоизычных выражений:
![Скриншот 4](pics/4.png)

## Документация для диплома

Подробное продуктовое и техническое описание проекта находится в [`docs/diploma-description.md`](docs/diploma-description.md).
